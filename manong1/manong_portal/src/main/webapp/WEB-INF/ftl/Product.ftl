...
<div class="topBar">
  <div class="comWidth">
    <div class="leftArea fl"> <a href="#" class="collection">收藏WistChen商城</a> </div>
    <div class="rightArea fr"> 喵!欢迎来到wistChen商城！ <a href="#" class="">[登录]</a><a href="#" class="">[免费注册]</a> </div>
  </div>
</div>
<!----logo区-------------------------------------------->
<div class="logoBar">
  <div class="comWidth">
    <div class="logo fl"> <a href=""><img src="images/logo.gif" alt="wistChen商城"/></a> </div>
...
<div class="comWidth clearfix Products">
  ...
  <div class="Products_show">
        <div class="Products_title"><h3>wistchen</h3></div>
        <div class="Products_list">
            <#list products as product>
                <div class="Products_item">
                    <div class="item_img"><a href="#"><img src="${product.imgUrl}" alt="" width="200px"/></a></div>
                    <div class="item_cont">
